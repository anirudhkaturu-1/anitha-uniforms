...
const Child = () => {
  ...
  useEffect(() => {
    // Note: Ensure "Kids" matches the category name used in your database
    const kidsCategory = products.filter((item) => item.category === "Kids");
    setCategoryKids(kidsCategory.slice(0, 50));
  }, [products]);
      ...
      {categoryKids && categoryKids.length > 0 ? (
        ...
        <div className="flex justify-center items-center py-20">
          <p className="text-gray-500 text-lg animate-pulse">
            Sweet styles for the little ones coming soon...
          </p>
        </div>
      )}
    </>
